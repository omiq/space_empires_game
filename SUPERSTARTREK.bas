...
205 REM COMMODORE BASIC VERSION BY DAVID R PARKER
210 REM V0.1 ADAPTED FOR 40 COLUMN SCREEN
211 REM      REDUNDANT REM STATEMENTS REMOVED
212 REM      SPELLING ERRORS CORRECTED
213 REM      US ENGLISH SPELLING RETAINED
215 REM ***
...
223 PRINT SPC(6);"'-------- --'      / /"
224 PRINT SPC(10);",---' '-------/ /--,"
225 PRINT SPC(11);"'----------------'":PRINT
226 PRINT SPC(5);"THE USS ENTERPRISE - NCC-1701"
...
1252 PRINT" HAVE INVADED THE GALAXY BEFORE THEY"
1258 PRINT" CAN ATTACK FEDERATION HEADQUARTERS ON"
1260 PRINT" STARDATE";T0+T9
1265 PRINT" THIS GIVES YOU";T9;"DAYS."
1272 PRINT" THERE";XO$;B9;"STARBASE";X$;" IN THE GALAXY"
...
2030 PRINT"YOUR SHIP IN SPACE:":PRINT"YOU HAVE INSUFFICIENT MANEUVERING"
2040 PRINT"ENERGY, AND SHIELD CONTROL IS PRESENTLY"
2050 PRINT"INCAPABLE OF CROSS-CIRCUITING TO ENGINE":PRINT"ROOM!!":GOTO 622
0
...
2330 PRINT"LT. SULU REPORTS:":PRINT"'INCORRECT COURSE DATA, SIR!'":GOTO 19
90
...
2500 PRINT"ENGINEERING REPORTS:":PRINT"'INSUFFICIENT ENERGY AVAILABLE FOR"

2510 PRINT"MANEUVERING AT WARP";W1;"!'"
2530 IFS<N-EORD(7)<0THEN1990
2550 PRINT"DEFLECTOR CONTROL ROOM ACKNOWLEDGES"
2555 PRINT S;"UNITS OF ENERGY PRESENTLY DEPLOYED TO";:PRINT"SHIELDS."
2570 GOTO1990
...
3790 IFX5=0THEN3860
3800 PRINT"LT. UHURA MESSAGE FROM STARFLEET:":PRINT"COMMAND:"
3810 PRINT"'PERMISSION TO ATTEMPT CROSSING OF"
3820 PRINT" GALACTIC PERIMETER IS HEREBY *DENIED*."
3825 PRINT" SHUT DOWN YOUR ENGINES.'"
3830 PRINT"CHIEF ENGINEER SCOTT REPORTS:"
3840 PRINT"'WARP ENGINES SHUT DOWN AT SECTOR ";
3845 PRINT RIGHT$(STR$(S1),1);",";RIGHT$(STR$(S2),1);
3847 PRINT" OF QUADRANT ";RIGHT$(STR$(Q1),1);",";RIGHT$(STR$(Q2),1);".'"
...
4280 PRINT"'SENSORS SHOW NO ENEMY SHIPS IN THIS":PRINT" QUADRANT.'":GOTO 1
990
...
4500 PRINT"SENSORS SHOW NO DAMAGE TO ENEMY AT ";RIGHT$(STR$(K(I,1)),1);","
;
4510 PRINT RIGHT$(STR$(K(I,2)),1):GOTO 4670
4530 K(I,3)=K(I,3)-H:PRINTH;"UNIT HIT ON KLINGON AT SECTOR ";
4535 PRINT RIGHT$(STR$(K(I,1)),1);",";RIGHT$(STR$(K(I,2)),1)
4550 IFK(I,3)<=0THENPRINT"*** KLINGON DESTROYED ***":GOTO4580
...
5260 PRINT"STAR AT";X3;",";Y3;"ABSORBED TORPEDO ENERGY.":GOSUB6000:GOTO199
0
5280 A$=">!<":Z1=X:Z2=Y:GOSUB8830:IFZ3=0THEN4760
5330 PRINT"*** STARBASE DESTROYED ***":B3=B3-1:B9=B9-1
5360 IFB9>0ORK9>T-T0-T9THEN5400
5370 PRINT"THAT DOES IT, CAPTAIN!!"
5375 PRINT"YOU ARE HERBY RELIEVED OF COMMAND AND"
5380 PRINT"SENTENCED TO 99 STARDATES AT HARD LABOR";:PRINT"ON CYGNUS 12!!"
...
6280 PRINT"CRUISERS LEFT AT THE END OF YOUR MISSION";
6290 PRINT:PRINT:IFB9=0THEN6360
6310 PRINT"THE FEDERATION IS IN NEED OF A NEW"
6320 PRINT"STARSHIP COMMANDER FOR A SIMILAR MISSION,"
6325 PRINT"LET HIM STEP FORWARD"
6330 INPUT"AND ENTER 'AYE'";A$:IFA$="AYE"THEN 10
6360 END
6370 PRINT"CONGRATULATIONS, CAPTAIN!"
6380 PRINT"THE LAST KLINGON BATTLE CRUISER MENACING";
6385 PRINT"THE GALAXY HAS BEEN DESTROYED.":PRINT
...
6820 FORJ=(I-1)*24+1TO(I-1)*24+22STEP3:PRINT MID$(Q$,J,3);:NEXT J
...
6960 PRINT"QUADRANT  ";RIGHT$(STR$(Q1),1);",";RIGHT$(STR$(Q2),1):GOTO 7260

7020 PRINT"SECTOR    ";RIGHT$(STR$(S1),1);",";RIGHT$(STR$(S2),1):GOTO 7260

7070 PRINT"TORPEDOES  ";INT(P):GOTO7260
7120 PRINT"ENERGY    ";RIGHT$(STR$(INT(E+S)),4):GOTO 7260
...
7543 PRINT
7544 PRINT"GALAXY COMPUTER RECORD FOR QUADRANT ";
7546 PRINT RIGHT$(STR$(Q1),1);",";RIGHT$(STR$(Q2),1)
7550 PRINT"   1   2   3   4   5   6   7   8"
7560 O1$="  --- --- --- --- --- --- --- ---"
7570 PRINT O1$:FOR I=1 TO 8:PRINT RIGHT$(STR$(I),1);:IF H8=0 THEN 7740
